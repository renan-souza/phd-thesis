...
\begin{document}
 ...
 \include{chapters/chap04}
  ...
  \appendix
  %\include{chapters/extras/one-page}
   \crossref{nos apendices -- A2: fez falta uma descrição e mais detalhes do que está disponível no github;  V3: adicionar detalhes do que esta no Github}
  \include{appendix/sql}
  \include{appendix/dfadapter}
  
  
  %\include{chapters/extras/todo_notes}
